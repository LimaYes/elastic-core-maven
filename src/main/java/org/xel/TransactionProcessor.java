...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    enum Event {
        ...
        REMOVED_UNCONFIRMED_TRANSACTIONS_COMPUTATION,
        ADDED_UNCONFIRMED_TRANSACTIONS_COMPUTATION,
        ADDED_CONFIRMED_TRANSACTIONS_COMPUTATION,
        RELEASE_PHASED_TRANSACTION_COMPUTATION,
        REJECT_PHASED_TRANSACTION_COMPUTATION
    }
