...
public final class Constants {
    ...
    public static final int MAX_ARBITRARY_MESSAGE_LENGTH = 158*1024;
    public static final int MAX_ARBITRARY_MESSAGE_LENGTH_MAINCHAIN = 160;
    ...
    public static final int[] MIN_VERSION = (isTestnet)?new int[] {5, 1, 0}:new int[] {3, 1, 0};
    public static final int[] MIN_PROXY_VERSION = (isTestnet)?new int[] {5, 1, 0}:new int[] {3, 1, 0};
