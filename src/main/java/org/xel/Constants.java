...
public final class Constants {
    ...
    public static final int[] MIN_VERSION = (isTestnet)?new int[] {5, 0, 0}:new int[] {3, 1, 0};
    public static final int[] MIN_PROXY_VERSION = (isTestnet)?new int[] {5, 0, 0}:new int[] {3, 1, 0};
