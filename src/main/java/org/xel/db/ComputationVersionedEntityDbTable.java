...
public abstract class ComputationVersionedEntityDbTable<T> extends ComputationalEntityDbTable<T> {

    protected ComputationVersionedEntityDbTable(String table, DbKey.Factory<T> dbKeyFactory) {
        super(table, dbKeyFactory, true, null);
    }

    protected ComputationVersionedEntityDbTable(String table, DbKey.Factory<T> dbKeyFactory, String fullTextSearchColumns) {
