...
public abstract class ComputationalEntityDbTable<T> extends ComputationalDerivedDbTable {
    ...
    protected ComputationalEntityDbTable(String table, DbKey.Factory<T> dbKeyFactory) {
        this(table, dbKeyFactory, false, null);
    }

    protected ComputationalEntityDbTable(String table, DbKey.Factory<T> dbKeyFactory, String fullTextSearchColumns) {
        this(table, dbKeyFactory, false, fullTextSearchColumns);
    }

    ComputationalEntityDbTable(String table, DbKey.Factory<T> dbKeyFactory, boolean multiversion, String fullTextSearchColumns) {
        super(table);
