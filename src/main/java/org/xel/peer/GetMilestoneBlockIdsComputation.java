...
final class GetMilestoneBlockIdsComputation extends PeerServlet.PeerRequestHandler {

    static final GetMilestoneBlockIdsComputation instance = new GetMilestoneBlockIdsComputation();

    private GetMilestoneBlockIdsComputation() {}
